...
esp_err_t DHT::sensorWakeup() {
    ...
    case DHT_TYPE_DHT12: {
        ...
        ets_delay_us( 20000 ); // Hold for 20000uS == 20mS
        break;
    }
    case DHT_TYPE_DHT21:
    case DHT_TYPE_DHT22:
    case DHT_TYPE_AM2301: {
        ...
        ets_delay_us( 1000 ); // Hold for 1000uS
        break;
    }
    };
    ...
    ets_delay_us( this->bus_release_time_us ); // Wait for bus release
...
esp_err_t DHT::singleRead( float *t, float *h ) {
    ...
    ets_delay_us( this->bus_max_read_time );
